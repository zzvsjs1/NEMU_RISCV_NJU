...
asm(".section .text\n"
    ...
    FP_ASM_BINARY_S(rv64_fp_add_s, fadd.s) FP_ASM_BINARY_S(rv64_fp_sub_s, fsub.s) FP_ASM_BINARY_S(rv64_fp_mul_s, fmul.s)
        FP_ASM_BINARY_S(rv64_fp_div_s, fdiv.s) FP_ASM_UNARY_S(rv64_fp_sqrt_s, fsqrt.s) FP_ASM_BINARY_D(rv64_fp_add_d, fadd.d)
            FP_ASM_BINARY_D(rv64_fp_sub_d, fsub.d) FP_ASM_BINARY_D(rv64_fp_mul_d, fmul.d) FP_ASM_BINARY_D(rv64_fp_div_d, fdiv.d)
                FP_ASM_UNARY_D(rv64_fp_sqrt_d, fsqrt.d)

                    FP_ASM_FMA_S(rv64_fp_madd_s, fmadd.s) FP_ASM_FMA_S(rv64_fp_msub_s, fmsub.s) FP_ASM_FMA_S(rv64_fp_nmsub_s, fnmsub.s)
                        FP_ASM_FMA_S(rv64_fp_nmadd_s, fnmadd.s) FP_ASM_FMA_D(rv64_fp_madd_d, fmadd.d) FP_ASM_FMA_D(rv64_fp_msub_d, fmsub.d)
                            FP_ASM_FMA_D(rv64_fp_nmsub_d, fnmsub.d) FP_ASM_FMA_D(rv64_fp_nmadd_d, fnmadd.d)
...
{
    check(rv64_fp_sub_s(UINT32_C(0x40700000), UINT32_C(0x40100000)) == UINT64_C(0xffffffff3fc00000));
    check(rv64_fp_mul_s(UINT32_C(0x3fc00000), UINT32_C(0x40000000)) == UINT64_C(0xffffffff40400000));
    check(rv64_fp_div_s(UINT32_C(0x40400000), UINT32_C(0x40000000)) == UINT64_C(0xffffffff3fc00000));
    check(rv64_fp_sqrt_s(UINT32_C(0x40800000)) == UINT64_C(0xffffffff40000000));

    check(rv64_fp_sub_d(UINT64_C(0x400e000000000000), UINT64_C(0x4002000000000000)) == UINT64_C(0x3ff8000000000000));
    check(rv64_fp_mul_d(UINT64_C(0x3ff8000000000000), UINT64_C(0x4000000000000000)) == UINT64_C(0x4008000000000000));
    check(rv64_fp_div_d(UINT64_C(0x4008000000000000), UINT64_C(0x4000000000000000)) == UINT64_C(0x3ff8000000000000));
    check(rv64_fp_sqrt_d(UINT64_C(0x4010000000000000)) == UINT64_C(0x4000000000000000));
}
...
static void test_fused_operations(void)
{
    ...
    check(rv64_fp_madd_s(s_two, s_three, s_four) == UINT64_C(0xffffffff41200000));
    check(rv64_fp_msub_s(s_two, s_three, s_four) == UINT64_C(0xffffffff40000000));
    check(rv64_fp_nmsub_s(s_two, s_three, s_four) == UINT64_C(0xffffffffc0000000));
    check(rv64_fp_nmadd_s(s_two, s_three, s_four) == UINT64_C(0xffffffffc1200000));

    check(rv64_fp_madd_d(d_two, d_three, d_four) == UINT64_C(0x4024000000000000));
    check(rv64_fp_msub_d(d_two, d_three, d_four) == UINT64_C(0x4000000000000000));
    check(rv64_fp_nmsub_d(d_two, d_three, d_four) == UINT64_C(0xc000000000000000));
    check(rv64_fp_nmadd_d(d_two, d_three, d_four) == UINT64_C(0xc024000000000000));
     ...
     */
    check(rv64_fp_msub_s(UINT32_C(0x3f800001), UINT32_C(0x3f7fffff), UINT32_C(0x3f800000)) == UINT64_C(0xffffffff337ffffe));
}
...
static void test_rounding_and_accrued_flags(void)
{
    ...
    write_fflags(0);
    check(rv64_fp_div_s(UINT32_C(0x3f800000), 0) == UINT64_C(0xffffffff7f800000));
    check(read_fflags() == UINT64_C(0x08));

    /* A later exact operation must not clear an earlier accrued DZ flag. */
    check(rv64_fp_mul_d(UINT64_C(0x4000000000000000), UINT64_C(0x4008000000000000)) == UINT64_C(0x4018000000000000));
    check(read_fflags() == UINT64_C(0x08));

    write_fflags(0);
    check(rv64_fp_sqrt_s(UINT32_C(0xbf800000)) == UINT64_C(0xffffffff7fc00000));
    check(read_fflags() == UINT64_C(0x10));

    write_fflags(0);
    check(rv64_fp_mul_s(UINT32_C(0x7f7fffff), UINT32_C(0x40000000)) == UINT64_C(0xffffffff7f800000));
...
static void test_nan_underflow_and_invalid_conversion_edges(void)
{
     ...
     */
    write_fflags(0);
    check(rv64_fp_add_s(UINT32_C(0x7f800001), UINT32_C(0x3f800000)) == UINT64_C(0xffffffff7fc00000));
    check(read_fflags() == UINT64_C(0x10));

    write_fflags(0);
    check(rv64_fp_add_d(UINT64_C(0x7ff8000000000123), UINT64_C(0x3ff0000000000000)) == UINT64_C(0x7ff8000000000000));
    check(read_fflags() == 0);
     ...
     */
    write_fflags(0);
    check(rv64_fp_madd_s(UINT32_C(0x7f800000), UINT32_C(0x00000000), UINT32_C(0x7fc00000)) == UINT64_C(0xffffffff7fc00000));
    check(read_fflags() == UINT64_C(0x10));
     ...
     */
    write_fflags(0);
    check(rv64_fp_mul_s(UINT32_C(0x007ffff0), UINT32_C(0x3f800010)) == UINT64_C(0xffffffff00800000));
    check(read_fflags() == UINT64_C(0x01));

    /* An exactly representable subnormal result raises no exception flags. */
    write_fflags(0);
    check(rv64_fp_mul_s(UINT32_C(0x00800000), UINT32_C(0x3f000000)) == UINT64_C(0xffffffff00400000));
    check(read_fflags() == 0);

    /* A tiny, inexact subnormal result raises both UF and NX. */
    write_fflags(0);
    check(rv64_fp_mul_s(UINT32_C(0x00800001), UINT32_C(0x3f000000)) == UINT64_C(0xffffffff00400000));
     ...
     */
    write_fflags(0);
    check(rv64_fp_cvt_w_d(UINT64_C(0x7ff0000000000000)) == UINT64_C(0x000000007fffffff));
    check(read_fflags() == UINT64_C(0x10));

    write_fflags(0);
    check(rv64_fp_cvt_wu_d(UINT64_C(0x7ff0000000000000)) == UINT64_MAX);
    check(read_fflags() == UINT64_C(0x10));

    write_fflags(0);
    check(rv64_fp_cvt_l_s(UINT32_C(0x7fc00000)) == UINT64_C(0x7fffffffffffffff));
    check(read_fflags() == UINT64_C(0x10));
...
static void test_integer_and_cross_precision_conversions(void)
{
    ...
    check(rv64_fp_cvt_l_d(UINT64_C(0x4270000000000000)) == UINT64_C(0x0000010000000000));
    check(rv64_fp_cvt_lu_d(UINT64_C(0x43e0000000000000)) == UINT64_C(0x8000000000000000));

    check(rv64_fp_cvt_s_w(UINT64_C(0xfffffffffffffffe)) == UINT64_C(0xffffffffc0000000));
    check(rv64_fp_cvt_s_wu(UINT64_C(0x00000000ffffffff)) == UINT64_C(0xffffffff4f800000));
    check(rv64_fp_cvt_s_l(UINT64_C(0xfffffffffffffffe)) == UINT64_C(0xffffffffc0000000));
    check(rv64_fp_cvt_s_lu(UINT64_C(0x0000000100000000)) == UINT64_C(0xffffffff4f800000));

    check(rv64_fp_cvt_d_w(UINT64_C(0xfffffffffffffffe)) == UINT64_C(0xc000000000000000));
    check(rv64_fp_cvt_d_wu(UINT64_C(0x00000000ffffffff)) == UINT64_C(0x41efffffffe00000));
    check(rv64_fp_cvt_d_l(UINT64_C(0xfffffffffffffffe)) == UINT64_C(0xc000000000000000));
    check(rv64_fp_cvt_d_lu(UINT64_C(0x0000000100000000)) == UINT64_C(0x41f0000000000000));

    check(rv64_fp_cvt_s_d(UINT64_C(0x3ff8000000000000)) == UINT64_C(0xffffffff3fc00000));
    check(rv64_fp_cvt_d_s(UINT32_C(0x3fc00000)) == UINT64_C(0x3ff8000000000000));
}
