...
asm(
    ...
    FP_ASM_BINARY_S(rv32_fp_add_s, fadd.s)
    FP_ASM_BINARY_S(rv32_fp_sub_s, fsub.s)
    FP_ASM_BINARY_S(rv32_fp_mul_s, fmul.s)
    FP_ASM_BINARY_S(rv32_fp_div_s, fdiv.s)
    FP_ASM_UNARY_S(rv32_fp_sqrt_s, fsqrt.s)

    FP_ASM_FMA_S(rv32_fp_madd_s, fmadd.s)
    FP_ASM_FMA_S(rv32_fp_msub_s, fmsub.s)
    FP_ASM_FMA_S(rv32_fp_nmsub_s, fnmsub.s)
    ...
    FP_ASM_CVT_W_S_STATIC(rv32_fp_cvt_w_s_rne, rne)
    FP_ASM_CVT_W_S_STATIC(rv32_fp_cvt_w_s_rtz, rtz)
    FP_ASM_CVT_W_S_STATIC(rv32_fp_cvt_w_s_rdn, rdn)
    FP_ASM_CVT_W_S_STATIC(rv32_fp_cvt_w_s_rup, rup)
    FP_ASM_CVT_W_S_STATIC(rv32_fp_cvt_w_s_rmm, rmm)
...
static void test_arithmetic_operations(void)
{
    ...
    check(rv32_fp_add_s(UINT32_C(0x3fc00000), UINT32_C(0x40000000)) ==
          UINT32_C(0x40600000));
    check(rv32_fp_sub_s(UINT32_C(0x40700000), UINT32_C(0x40100000)) ==
          UINT32_C(0x3fc00000));
    check(rv32_fp_mul_s(UINT32_C(0x3fc00000), UINT32_C(0x40000000)) ==
          UINT32_C(0x40400000));
    check(rv32_fp_div_s(UINT32_C(0x40400000), UINT32_C(0x40000000)) ==
          UINT32_C(0x3fc00000));
    check(rv32_fp_sqrt_s(UINT32_C(0x40800000)) ==
          UINT32_C(0x40000000));
    check(read_fflags() == 0);
}
...
static void test_fused_operations(void)
{
     ...
     */
    check(rv32_fp_msub_s(UINT32_C(0x3f800001),
                        UINT32_C(0x3f7fffff),
                        UINT32_C(0x3f800000)) ==
          UINT32_C(0x337ffffe));
}
...
static void test_rounding_modes_and_accrued_flags(void)
{
    ...
    static const uint32_t expected[5][3] = {
        {2u, UINT32_C(0xfffffffe), 3u},
        {2u, UINT32_C(0xfffffffe), 2u},
        {2u, UINT32_C(0xfffffffd), 2u},
        {3u, UINT32_C(0xfffffffe), 3u},
        {3u, UINT32_C(0xfffffffd), 3u},
    };
    ...
    for (uintptr_t rm = 0; rm < 5; rm++)
    {
        ...
        {
            write_fflags(0);
            check(rv32_fp_cvt_w_s_dyn(input[case_index]) ==
    ...
    check(read_fflags() == FFLAG_NX);
    write_fflags(0);
    check(rv32_fp_cvt_w_s_rdn(UINT32_C(0xc0200000)) ==
          UINT32_C(0xfffffffd));
    check(read_fflags() == FFLAG_NX);
    write_fflags(0);
    ...
    check(read_fflags() == FFLAG_NX);
    write_fflags(0);
    check(rv32_fp_cvt_w_s_rmm(UINT32_C(0xc0200000)) ==
          UINT32_C(0xfffffffd));
    check(read_fflags() == FFLAG_NX);

    write_fflags(0);
    check(rv32_fp_div_s(UINT32_C(0x3f800000), 0) ==
          UINT32_C(0x7f800000));
    check(read_fflags() == FFLAG_DZ);

    /* A later exact operation must not clear the earlier accrued DZ flag. */
    check(rv32_fp_mul_s(UINT32_C(0x40000000), UINT32_C(0x40400000)) ==
          UINT32_C(0x40c00000));
    check(read_fflags() == FFLAG_DZ);

    write_fflags(0);
    check(rv32_fp_sqrt_s(UINT32_C(0xbf800000)) ==
          UINT32_C(0x7fc00000));
    check(read_fflags() == FFLAG_NV);

    write_fflags(0);
    check(rv32_fp_mul_s(UINT32_C(0x7f7fffff), UINT32_C(0x40000000)) ==
          UINT32_C(0x7f800000));
...
static void test_nan_and_underflow_edges(void)
{
     ...
     */
    write_fflags(0);
    check(rv32_fp_add_s(UINT32_C(0x7f800001),
                       UINT32_C(0x3f800000)) ==
          UINT32_C(0x7fc00000));
    check(read_fflags() == FFLAG_NV);

    write_fflags(0);
    check(rv32_fp_add_s(UINT32_C(0x7fc00123),
                       UINT32_C(0x3f800000)) ==
          UINT32_C(0x7fc00000));
    check(read_fflags() == 0);
     ...
     */
    write_fflags(0);
    check(rv32_fp_madd_s(UINT32_C(0x7f800000),
                        UINT32_C(0x00000000),
                        UINT32_C(0x7fc00000)) ==
          UINT32_C(0x7fc00000));
    check(read_fflags() == FFLAG_NV);
     ...
     */
    write_fflags(0);
    check(rv32_fp_mul_s(UINT32_C(0x007ffff0),
                       UINT32_C(0x3f800010)) ==
          UINT32_C(0x00800000));
    check(read_fflags() == FFLAG_NX);
    ...
    write_fflags(0);
    check(rv32_fp_mul_s(UINT32_C(0x00800000),
                       UINT32_C(0x3f000000)) ==
          UINT32_C(0x00400000));
    check(read_fflags() == 0);
    ...
    write_fflags(0);
    check(rv32_fp_mul_s(UINT32_C(0x00800001),
                       UINT32_C(0x3f000000)) ==
          UINT32_C(0x00400000));
...
static void test_w_and_wu_conversions(void)
{
     ...
     */
    write_fflags(0);
    check(rv32_fp_cvt_w_s_dyn(UINT32_C(0x7f800000)) ==
          UINT32_C(0x7fffffff));
    check(read_fflags() == FFLAG_NV);

    write_fflags(0);
    check(rv32_fp_cvt_w_s_dyn(UINT32_C(0xff800000)) ==
          UINT32_C(0x80000000));
    check(read_fflags() == FFLAG_NV);

    write_fflags(0);
    check(rv32_fp_cvt_w_s_dyn(UINT32_C(0x7fc00000)) ==
          UINT32_C(0x7fffffff));
    check(read_fflags() == FFLAG_NV);

    write_fflags(0);
    check(rv32_fp_cvt_wu_s(UINT32_C(0x7f800000)) ==
          UINT32_C(0xffffffff));
    check(read_fflags() == FFLAG_NV);
    ...
    write_fflags(0);
    check(rv32_fp_cvt_s_w(UINT32_C(0xfffffffe)) ==
          UINT32_C(0xc0000000));
    check(read_fflags() == 0);
     ...
     */
    write_fflags(0);
    check(rv32_fp_cvt_s_wu(UINT32_C(0xffffffff)) ==
          UINT32_C(0x4f800000));
    check(read_fflags() == FFLAG_NX);
}
