...
{
  if (strcmp(name, "LEFT") == 0) return AM_MOUSE_BUTTON_LEFT;
  if (strcmp(name, "MIDDLE") == 0) return AM_MOUSE_BUTTON_MIDDLE;
  if (strcmp(name, "RIGHT") == 0) return AM_MOUSE_BUTTON_RIGHT;
  if (strcmp(name, "WHEELUP") == 0) return AM_MOUSE_BUTTON_WHEELUP;
  if (strcmp(name, "WHEELDOWN") == 0) return AM_MOUSE_BUTTON_WHEELDOWN;
...
static void __am_audio_status(AM_AUDIO_STATUS_T *status)
{
  ...
  if (status->count > NAVY_AM_AUDIO_BUFSIZE) status->count = NAVY_AM_AUDIO_BUFSIZE;
}
