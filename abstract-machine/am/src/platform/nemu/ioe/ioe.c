...
void __am_input_mouse(AM_INPUT_MOUSE_T *);
...
static void *lut[128] = {
    ...
    [AM_TIMER_REALTIME] = __am_timer_realtime, [AM_INPUT_CONFIG] = __am_input_config, [AM_INPUT_KEYBRD] = __am_input_keybrd,
    [AM_INPUT_MOUSE] = __am_input_mouse,       [AM_GPU_CONFIG] = __am_gpu_config,     [AM_GPU_FBDRAW] = __am_gpu_fbdraw,
    [AM_GPU_STATUS] = __am_gpu_status,         [AM_GPU_MEMCPY] = __am_gpu_memcpy,     [AM_GPU_RENDER] = __am_gpu_render,
