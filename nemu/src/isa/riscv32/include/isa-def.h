...
#define RISCV_XLEN_SHAMT_MASK \
    MUXDEF(CONFIG_RV64, \
           ((1u << RISCV64_SHAMT_WIDTH) - 1u), \
           RISCV32_WORD_SHAMT_MASK)
 ...
 */
#define RISCV_XCAUSE_INTERRUPT_MASK \
    MUXDEF(CONFIG_RV64, ((word_t)1ull << 63), ((word_t)1u << 31))
...
#define RISCV_MCAUSE_MACHINE_TIMER_INTERRUPT \
    (RISCV_XCAUSE_INTERRUPT_MASK | (word_t)RISCV_MACHINE_TIMER_INTERRUPT_CODE)
...
#define RISCV_MSTATUS_MPP_VALUE_MASK \
    ((word_t)((1u << RISCV_MSTATUS_MPP_WIDTH) - 1u))
#define RISCV_MSTATUS_MPP_MASK \
    (RISCV_MSTATUS_MPP_VALUE_MASK << RISCV_MSTATUS_MPP_SHIFT)
...
#define RISCV64_MSTATUS_XLEN_VALUE_MASK \
    ((UINT64_C(1) << RISCV64_MSTATUS_XLEN_WIDTH) - UINT64_C(1))
#define RISCV64_MSTATUS_UXL_MASK \
    (RISCV64_MSTATUS_XLEN_VALUE_MASK << RISCV64_MSTATUS_UXL_SHIFT)
#define RISCV64_MSTATUS_SXL_MASK \
    (RISCV64_MSTATUS_XLEN_VALUE_MASK << RISCV64_MSTATUS_SXL_SHIFT)
#define RISCV64_MSTATUS_UXL_SXL_MASK \
    (RISCV64_MSTATUS_UXL_MASK | RISCV64_MSTATUS_SXL_MASK)
#define RISCV64_MSTATUS_UXL_VALUE \
    ((uint64_t)RISCV64_MSTATUS_XLEN_ENCODING_64 << RISCV64_MSTATUS_UXL_SHIFT)
#define RISCV64_MSTATUS_SXL_VALUE \
    ((uint64_t)RISCV64_MSTATUS_XLEN_ENCODING_64 << RISCV64_MSTATUS_SXL_SHIFT)
#define RISCV64_MSTATUS_UXL_SXL_VALUE \
    (RISCV64_MSTATUS_UXL_VALUE | RISCV64_MSTATUS_SXL_VALUE)
...
#define RISCV_PTE_NON_LEAF_RESERVED \
...
#define RISCV32_SATP_MODE_MASK \
    (UINT32_C(1) << RISCV32_SATP_MODE_SHIFT)
#define RISCV32_SATP_PPN_MASK \
    ((UINT32_C(1) << RISCV32_SATP_PPN_WIDTH) - UINT32_C(1))
#define RISCV64_SATP_MODE_VALUE_MASK \
    ((UINT64_C(1) << RISCV64_SATP_MODE_WIDTH) - UINT64_C(1))
#define RISCV64_SATP_MODE_MASK \
    (RISCV64_SATP_MODE_VALUE_MASK << RISCV64_SATP_MODE_SHIFT)
#define RISCV64_SATP_PPN_MASK \
    ((UINT64_C(1) << RISCV64_SATP_PPN_WIDTH) - UINT64_C(1))
...
#define RISCV32_SV32_VPN_MASK \
    ((word_t)((1u << RISCV32_SV32_VPN_BITS) - 1u))
#define RISCV64_SV39_VPN_MASK \
    ((word_t)((1u << RISCV64_SV39_VPN_BITS) - 1u))
#define RISCV64_SV39_LEVEL1_LOW_PPN_MASK RISCV64_SV39_VPN_MASK
#define RISCV64_SV39_LEVEL2_LOW_PPN_MASK \
    ((word_t)((1u << (2u * RISCV64_SV39_VPN_BITS)) - 1u))
...
#define RISCV_MSTATUS_EXT_STATE_VALUE_MASK \
    ((word_t)((1u << RISCV_MSTATUS_EXT_STATE_WIDTH) - 1u))
#define RISCV_MSTATUS_VS_MASK \
    (RISCV_MSTATUS_EXT_STATE_VALUE_MASK << RISCV_MSTATUS_VS_SHIFT)
#define RISCV_MSTATUS_FS_MASK \
    (RISCV_MSTATUS_EXT_STATE_VALUE_MASK << RISCV_MSTATUS_FS_SHIFT)
#define RISCV_MSTATUS_FS_OFF \
    ((word_t)RISCV_MSTATUS_EXT_STATE_OFF << RISCV_MSTATUS_FS_SHIFT)
#define RISCV_MSTATUS_FS_INITIAL \
    ((word_t)RISCV_MSTATUS_EXT_STATE_INITIAL << RISCV_MSTATUS_FS_SHIFT)
#define RISCV_MSTATUS_FS_CLEAN \
    ((word_t)RISCV_MSTATUS_EXT_STATE_CLEAN << RISCV_MSTATUS_FS_SHIFT)
#define RISCV_MSTATUS_FS_DIRTY \
...
static inline word_t riscv_mstatus_normalise(word_t value)
{
     ...
     */
    if (((value & RISCV_MSTATUS_MPP_MASK) >>
         RISCV_MSTATUS_MPP_SHIFT) == RISCV_PRIV_RESERVED)
    {
