...
static uint32_t mouse_button_bit(uint32_t button)
{
    ...
    case MOUSE_BUTTON_LEFT:
        return MOUSE_BUTTON_LEFT_MASK;
    case MOUSE_BUTTON_MIDDLE:
        return MOUSE_BUTTON_MIDDLE_MASK;
    case MOUSE_BUTTON_RIGHT:
        return MOUSE_BUTTON_RIGHT_MASK;
    default:
        return 0;
    }
}
...
static void mouse_data_io_handler(uint32_t offset, int len, bool is_write)
{
    ...
    */
    ...
    {
    case 0x00:
        mouse_base[0] = mouse_latched.type;
        break;
    case 0x04:
        mouse_base[1] = mouse_latched.x;
        break;
    case 0x08:
        mouse_base[2] = mouse_latched.y;
        break;
    case 0x0c:
        mouse_base[3] = mouse_latched.button;
        break;
    case 0x10:
        mouse_base[4] = mouse_latched.buttons;
        break;
    case 0x14:
        mouse_base[5] = (uint32_t)mouse_latched.wheel_x;
        break;
    case 0x18:
        mouse_base[6] = (uint32_t)mouse_latched.wheel_y;
        break;
    default:
        assert(0);
    }
