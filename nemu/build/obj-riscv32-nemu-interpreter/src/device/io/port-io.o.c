...
# 5 "/home/zz/github/ics2021/nemu/include/cpu/difftest.h" 2
...
# 12 "src/device/io/port-io.c"
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "Add port-io map '%s' at [" "0x%08x" ", " "0x%08x" "]" "\33[0m" "\n", "src/device/io/port-io.c", 15, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Add port-io map '%s' at [" "0x%08x" ", " "0x%08x" "]" "\33[0m" "\n", "src/device/io/port-io.c", 15, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); fflush(log_fp); } } while (0); } while (0)
                                                             ;
...
# 25 "src/device/io/port-io.c" 3 4
 (static_cast <bool> (
# 25 "src/device/io/port-io.c"
 mapid != -1
# 25 "src/device/io/port-io.c" 3 4
 ) ? void (0) : __assert_fail (
# 25 "src/device/io/port-io.c"
 "mapid != -1"
# 25 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 25, __extension__ __PRETTY_FUNCTION__))
# 25 "src/device/io/port-io.c"
                    ;
...
# 30 "src/device/io/port-io.c"
 "addr + len - 1 < PORT_IO_SPACE_MAX"
# 30 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 30, __extension__ __PRETTY_FUNCTION__))
# 30 "src/device/io/port-io.c"
                                           ;
  int mapid = find_mapid_by_addr(maps, nr_map, addr);
  
# 32 "src/device/io/port-io.c" 3 4
 (static_cast <bool> (
# 32 "src/device/io/port-io.c"
 mapid != -1
# 32 "src/device/io/port-io.c" 3 4
 ) ? void (0) : __assert_fail (
# 32 "src/device/io/port-io.c"
 "mapid != -1"
# 32 "src/device/io/port-io.c" 3 4
 , "src/device/io/port-io.c", 32, __extension__ __PRETTY_FUNCTION__))
# 32 "src/device/io/port-io.c"
                    ;
