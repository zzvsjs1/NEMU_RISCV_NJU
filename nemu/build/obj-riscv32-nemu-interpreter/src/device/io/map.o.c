...
# 1 "/home/zz/github/ics2021/nemu/include/memory/host.h" 1
...
static inline word_t host_read(void *addr, int len) {
  switch (len) {
    ...
    ;
    default: 
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
            (static_cast <bool> (
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h"
            0
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
...
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h"
            "0"
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
            , "/home/zz/github/ics2021/nemu/include/memory/host.h", 12, __extension__ __PRETTY_FUNCTION__))
# 12 "/home/zz/github/ics2021/nemu/include/memory/host.h"
                                                        ;
  }
}
...
static inline void host_write(void *addr, int len, word_t data) {
  switch (len) {
    ...
    ;
    default: 
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
   (static_cast <bool> (
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h"
   0
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
   ) ? void (0) : __assert_fail (
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h"
   "0"
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h" 3 4
   , "/home/zz/github/ics2021/nemu/include/memory/host.h", 22, __extension__ __PRETTY_FUNCTION__))
# 22 "/home/zz/github/ics2021/nemu/include/memory/host.h"
                                             ;
  }
}
...
# 1 "/home/zz/github/ics2021/nemu/include/device/map.h" 1
...
# 5 "/home/zz/github/ics2021/nemu/include/device/map.h" 2
...
# 8 "src/device/io/map.c" 3 4
                          __null
# 8 "src/device/io/map.c"
                              ;
static uint8_t *p_space = 
# 9 "src/device/io/map.c" 3 4
                         __null
# 9 "src/device/io/map.c"
                             ;
...
# 21 "src/device/io/map.c"
    ...
    do { if (!(map != 
# 22 "src/device/io/map.c" 3 4
   __null
# 22 "src/device/io/map.c"
   )) { (fflush(
# 22 "src/device/io/map.c" 3 4
   stdout
# 22 "src/device/io/map.c"
...
# 22 "src/device/io/map.c" 3 4
   stderr
# 22 "src/device/io/map.c"
   , "\33[1;31m" "address (" "0x%08x" ") is out of bound at pc = " "0x%08x" "\33[0m" "\n", addr, cpu.pc)); extern void assert_fail_msg(); assert_fail_msg(); 
# 22 "src/device/io/map.c" 3 4
   (static_cast <bool> (
# 22 "src/device/io/map.c"
   map != 
...
# 22 "src/device/io/map.c"
   "map != __null"
# 22 "src/device/io/map.c" 3 4
   , "src/device/io/map.c", 22, __extension__ __PRETTY_FUNCTION__))
# 22 "src/device/io/map.c"
   ; } } while (0);
  } else {
...
# 24 "src/device/io/map.c" 3 4
   stderr
# 24 "src/device/io/map.c"
   , "\33[1;31m" "address (" "0x%08x" ") is out of bound {%s} [" "0x%08x" ", " "0x%08x" "] at pc = " "0x%08x" "\33[0m" "\n", addr, map->name, map->low, map->high, cpu.pc)); extern void assert_fail_msg(); assert_fail_msg(); 
# 24 "src/device/io/map.c" 3 4
   (static_cast <bool> (
# 24 "src/device/io/map.c"
...
# 24 "src/device/io/map.c"
   "addr <= map->high && addr >= map->low"
# 24 "src/device/io/map.c" 3 4
   , "src/device/io/map.c", 24, __extension__ __PRETTY_FUNCTION__))
# 24 "src/device/io/map.c"
   ; } } while (0)
...
# 36 "src/device/io/map.c"
 "io_space"
# 36 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 36, __extension__ __PRETTY_FUNCTION__))
# 36 "src/device/io/map.c"
                 ;
  p_space = io_space;
}
...
# 41 "src/device/io/map.c" 3 4
 (static_cast <bool> (
# 41 "src/device/io/map.c"
 len >= 1 && len <= 8
# 41 "src/device/io/map.c" 3 4
 ) ? void (0) : __assert_fail (
# 41 "src/device/io/map.c"
 "len >= 1 && len <= 8"
# 41 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 41, __extension__ __PRETTY_FUNCTION__))
# 41 "src/device/io/map.c"
                             ;
...
# 50 "src/device/io/map.c" 3 4
 (static_cast <bool> (
# 50 "src/device/io/map.c"
 len >= 1 && len <= 8
# 50 "src/device/io/map.c" 3 4
 ) ? void (0) : __assert_fail (
# 50 "src/device/io/map.c"
 "len >= 1 && len <= 8"
# 50 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 50, __extension__ __PRETTY_FUNCTION__))
# 50 "src/device/io/map.c"
                             ;
  check_bound(map, addr);
  paddr_t offset = addr - map->low;
