...
# 5 "/home/zz/github/ics2021/nemu/include/memory/host.h" 2
...
# 1 "/home/zz/github/ics2021/nemu/include/device/mmio.h" 1
...
void init_mem()
{
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "physical memory area [" "0x%08x" ", " "0x%08x" "]" "\33[0m" "\n", "src/memory/paddr.c", 45, __func__, (paddr_t)0x80000000, (paddr_t)0x80000000 + 0x8000000); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "physical memory area [" "0x%08x" ", " "0x%08x" "]" "\33[0m" "\n", "src/memory/paddr.c", 45, __func__, (paddr_t)0x80000000, (paddr_t)0x80000000 + 0x8000000); fflush(log_fp); } } while (0); } while (0)
                                                                  ;
}
...
# 56 "src/memory/paddr.c" 3 4
 stderr
# 56 "src/memory/paddr.c"
 , "\33[1;31m" "address = " "0x%08x" " is out of bound of pmem [" "0x%08x" ", " "0x%08x" ") at pc = " "0x%08x" "\33[0m" "\n", addr, 0x80000000, 0x80000000 + 0x8000000, cpu.pc)); extern void assert_fail_msg(); assert_fail_msg(); 
# 56 "src/memory/paddr.c" 3 4
 (static_cast <bool> (
# 56 "src/memory/paddr.c"
 0
...
# 70 "src/memory/paddr.c"
 "0"
# 70 "src/memory/paddr.c" 3 4
 , "src/memory/paddr.c", 71, __extension__ __PRETTY_FUNCTION__))
# 70 "src/memory/paddr.c"
 ; } } while (0)
