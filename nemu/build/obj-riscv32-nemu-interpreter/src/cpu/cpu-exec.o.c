...
# 1 "/home/zz/github/ics2021/nemu/include/cpu/cpu.h" 1
...
# 5 "/home/zz/github/ics2021/nemu/include/cpu/cpu.h" 2

void cpu_exec(uint64_t n);
# 2 "src/cpu/cpu-exec.c" 2
# 1 "/home/zz/github/ics2021/nemu/include/cpu/exec.h" 1
...
# 5 "/home/zz/github/ics2021/nemu/include/cpu/exec.h" 2
...
# 1 "/home/zz/github/ics2021/nemu/include/difftest-def.h" 1
...
#define CONFIG_TRACE 1
#define CONFIG_ISA "riscv32"
# 6 "/home/zz/github/ics2021/nemu/include/difftest-def.h" 2
...
# 6 "/home/zz/github/ics2021/nemu/include/cpu/difftest.h" 2
# 15 "/home/zz/github/ics2021/nemu/include/cpu/difftest.h"
...
static inline bool difftest_check_reg(const char *name, vaddr_t pc, rtlreg_t ref, rtlreg_t dut) {
  if (ref != dut) {
    do { printf("\33[1;34m" "[%s:%d %s] " "%s is different after executing instruction at pc = " "0x%08x" ", right = " "0x%08x" ", wrong = " "0x%08x" "\33[0m" "\n", "/home/zz/github/ics2021/nemu/include/cpu/difftest.h", 30, __func__, name, pc, ref, dut); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "%s is different after executing instruction at pc = " "0x%08x" ", right = " "0x%08x" ", wrong = " "0x%08x" "\33[0m" "\n", "/home/zz/github/ics2021/nemu/include/cpu/difftest.h", 30, __func__, name, pc, ref, dut); fflush(log_fp); } } while (0); } while (0)
                                                                        ;
    return false;
  }
  return true;
...
# 6 "/home/zz/github/ics2021/nemu/src/engine/interpreter/rtl-basic.h" 2
...
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h" 3 4
(static_cast <bool> (
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h"
idx >= 0 && idx < 32
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h" 3 4
) ? void (0) : __assert_fail (
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h"
"idx >= 0 && idx < 32"
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h" 3 4
, "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h", 8, __extension__ __PRETTY_FUNCTION__))
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h"
                                                    ;
 return idx;
}
...
# 16 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/isa-all-instr.h"
enum { EXEC_ID_lui, EXEC_ID_lw, EXEC_ID_sw, EXEC_ID_inv, EXEC_ID_addi, EXEC_ID_auipc, EXEC_ID_jal, EXEC_ID_jalr, EXEC_ID_nemu_trap, TOTAL_INSTR };
...
static void trace_and_difftest(Decode *_this, vaddr_t dnpc)
{
    ...
    if (true)
    {
        do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "%s\n", _this->logbuf); fflush(log_fp); } } while (0);
    }
...
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/isa-exec.h" 1
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/compute.h" 1
...
static inline void exec_addi (Decode *s)
{
    ...
    rtl_add(s, ((&(s->dest))->preg), ((&(s->src1))->preg), (tmp_reg));
}
...
# 3 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h" 3 4
                                 __null
# 3 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h"
                                     , 
# 3 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h" 3 4
                                       __null
# 3 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h"
...
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h" 3 4
                                  __null
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h"
                                      , &(cpu.gpr[check_reg_idx(10)]._32), 
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h" 3 4
                                                  __null
# 8 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/special.h"
                                                      , 0);
}
# 4 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/isa-exec.h" 2
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../instr/control-transfer.h" 1
...
static inline void exec_jal (Decode *s)
{
    ...
    rtl_addi(s, ((&(s->dest))->preg), &s->pc, sizeof(rtlreg_t));
...
static inline void exec_jalr (Decode *s)
{
    ...
    rtl_sign_ext_pos(s, (tmp_reg), (tmp_reg), 12 - 1);
...
static const void* g_exec_table[TOTAL_INSTR] = {
    [EXEC_ID_lui] = exec_lui, [EXEC_ID_lw] = exec_lw, [EXEC_ID_sw] = exec_sw, [EXEC_ID_inv] = exec_inv, [EXEC_ID_addi] = exec_addi, [EXEC_ID_auipc] = exec_auipc, [EXEC_ID_jal] = exec_jal, [EXEC_ID_jalr] = exec_jalr, [EXEC_ID_nemu_trap] = exec_nemu_trap,
};
...
{
    setlocale(
# 65 "src/cpu/cpu-exec.c" 3 4
   1
# 65 "src/cpu/cpu-exec.c"
   , "");
#define NUMBERIC_FMT MUXDEF(CONFIG_TARGET_AM, "%ld", "%'ld")
    do { printf("\33[1;34m" "[%s:%d %s] " "host time spent = " "%'ld" " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 67, __func__, g_timer); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "host time spent = " "%'ld" " us" "\33[0m" "\n", "src/cpu/cpu-exec.c", 67, __func__, g_timer); fflush(log_fp); } } while (0); } while (0);
    do { printf("\33[1;34m" "[%s:%d %s] " "total guest instructions = " "%'ld" "\33[0m" "\n", "src/cpu/cpu-exec.c", 68, __func__, g_nr_guest_instr); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "total guest instructions = " "%'ld" "\33[0m" "\n", "src/cpu/cpu-exec.c", 68, __func__, g_nr_guest_instr); fflush(log_fp); } } while (0); } while (0);

    if (g_timer > 0)
    {
        do { printf("\33[1;34m" "[%s:%d %s] " "simulation frequency = " "%'ld" " instr/s" "\33[0m" "\n", "src/cpu/cpu-exec.c", 72, __func__, g_nr_guest_instr * 1000000 / g_timer); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "simulation frequency = " "%'ld" " instr/s" "\33[0m" "\n", "src/cpu/cpu-exec.c", 72, __func__, g_nr_guest_instr * 1000000 / g_timer); fflush(log_fp); } } while (0); } while (0);
        return;
    }

    do { printf("\33[1;34m" "[%s:%d %s] " "Finish running in less than 1 us and can not calculate the simulation frequency" "\33[0m" "\n", "src/cpu/cpu-exec.c", 76, __func__); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Finish running in less than 1 us and can not calculate the simulation frequency" "\33[0m" "\n", "src/cpu/cpu-exec.c", 76, __func__); fflush(log_fp); } } while (0); } while (0);
}
...
void fetch_decode(Decode *s, vaddr_t pc)
{
    ...
    disassemble(p, s->logbuf + sizeof(s->logbuf) - p,
            s->pc, (uint8_t *)&s->isa.instr.val, ilen);
...
void cpu_exec(uint64_t n)
{
    ...
    switch (nemu_state.state)
    {
        ...
        case NEMU_END:
        case NEMU_ABORT:
            do { printf("\33[1;34m" "[%s:%d %s] " "nemu: %s at pc = " "0x%08x" "\33[0m" "\n", "src/cpu/cpu-exec.c", 165, __func__, (nemu_state.state == NEMU_ABORT ? "\33[1;31m" "ABORT" "\33[0m" : (nemu_state.halt_ret == 0 ? "\33[1;32m" "HIT GOOD TRAP" "\33[0m" : "\33[1;31m" "HIT BAD TRAP" "\33[0m")), nemu_state.halt_pc); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "nemu: %s at pc = " "0x%08x" "\33[0m" "\n", "src/cpu/cpu-exec.c", 165, __func__, (nemu_state.state == NEMU_ABORT ? "\33[1;31m" "ABORT" "\33[0m" : (nemu_state.halt_ret == 0 ? "\33[1;32m" "HIT GOOD TRAP" "\33[0m" : "\33[1;31m" "HIT BAD TRAP" "\33[0m")), nemu_state.halt_pc); fflush(log_fp); } } while (0); } while (0)
