...
# 2 "src/monitor/monitor.c" 2
# 1 "/home/zz/github/ics2021/nemu/include/memory/paddr.h" 1
...
static void welcome()
{
    do { printf("\33[1;34m" "[%s:%d %s] " "Trace: %s" "\33[0m" "\n", "src/monitor/monitor.c", 15, __func__, "\33[1;32m" "ON" "\33[0m"); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Trace: %s" "\33[0m" "\n", "src/monitor/monitor.c", 15, __func__, "\33[1;32m" "ON" "\33[0m"); fflush(log_fp); } } while (0); } while (0);
    do { printf("\33[1;34m" "[%s:%d %s] " "If trace is enabled, a log file will be generated " "to record the trace. This may lead to a large log file. " "If it is not necessary, you can disable it in menuconfig" "\33[0m" "\n", "src/monitor/monitor.c", 16, __func__); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "If trace is enabled, a log file will be generated " "to record the trace. This may lead to a large log file. " "If it is not necessary, you can disable it in menuconfig" "\33[0m" "\n", "src/monitor/monitor.c", 16, __func__); fflush(log_fp); } } while (0); } while (0)
                                                                            ...
                                                                            ;
    do { printf("\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 19, __func__, "09:14:07", "Jul  6 2022"); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 19, __func__, "09:14:07", "Jul  6 2022"); fflush(log_fp); } } while (0); } while (0);
...
# 26 "src/monitor/monitor.c" 2


# 27 "src/monitor/monitor.c"
...
{
        do { printf("\33[1;34m" "[%s:%d %s] " "No image is given. Use the default build-in image." "\33[0m" "\n", "src/monitor/monitor.c", 39, __func__); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "No image is given. Use the default build-in image." "\33[0m" "\n", "src/monitor/monitor.c", 39, __func__); fflush(log_fp); } } while (0); } while (0);
        return 4096;
    }
...
# 44 "src/monitor/monitor.c" 3 4
   stderr
# 44 "src/monitor/monitor.c"
   , "\33[1;31m" "Can not open '%s'" "\33[0m" "\n", img_file)); extern void assert_fail_msg(); assert_fail_msg(); 
# 44 "src/monitor/monitor.c" 3 4
   (static_cast <bool> (
# 44 "src/monitor/monitor.c"
   fp
...
# 44 "src/monitor/monitor.c"
   "fp"
# 44 "src/monitor/monitor.c" 3 4
   , "src/monitor/monitor.c", 44, __extension__ __PRETTY_FUNCTION__))
# 44 "src/monitor/monitor.c"
   ; } } while (0);
...
# 46 "src/monitor/monitor.c"
    ...
    do { printf("\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 49, __func__, img_file, size); do { extern FILE* log_fp; extern bool log_enable(); if (log_fp && log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 49, __func__, img_file, size); fflush(log_fp); } } while (0); } while (0);
...
# 51 "src/monitor/monitor.c"
    ...
    int ret = fread(guest_to_host((0x80000000 + 0x0)), size, 1, fp);
...
# 53 "src/monitor/monitor.c"
   "ret == 1"
# 53 "src/monitor/monitor.c" 3 4
   , "src/monitor/monitor.c", 53, __extension__ __PRETTY_FUNCTION__))
# 53 "src/monitor/monitor.c"
                   ;
...
# 66 "src/monitor/monitor.c"
                                            , 'e'},
    {"help" , 
# 67 "src/monitor/monitor.c" 3 4
                     0 
# 67 "src/monitor/monitor.c"
                                      , 
# 67 "src/monitor/monitor.c" 3 4
                                        __null
# 67 "src/monitor/monitor.c"
...
static void exprTest()
{
 ...
 char* otherBuffer = (char*)malloc((4096) * sizeof(char));
 ...
 {
  if (sscanf(str, "%" 
# 120 "src/monitor/monitor.c" 3 4
                 "u" 
# 120 "src/monitor/monitor.c"
                               " %[^\n]\n", &a, otherBuffer) != 2)
  {
   printf("Cannot scan value from buffer.\n");
   goto error;
  }
        ...
        if (!success)
        {
            printf("\33[1;31m" "Calulate failed for " "%" 
# 130 "src/monitor/monitor.c" 3 4
                  "u" 
# 130 "src/monitor/monitor.c"
                  " %s\n" "\33[0m", a, otherBuffer);
        }
        else if (res != a)
        {
            printf("\33[1;31m" "Cal failed Input: %u %s\n" "The out is %u\n" "\33[0m"
 ...
 if (!feof(f) && ferror(f))
 {
  printf("\nStream error in checking expressions.\n");
 }
...
error:
 fclose(f);
    ...
    free(otherBuffer);
 f = 
# 153 "src/monitor/monitor.c" 3 4
    __null
# 153 "src/monitor/monitor.c"
        ;
    printf("\33[1;35m" "Check %zu expressions.\n\n" "\33[0m", count);
}
