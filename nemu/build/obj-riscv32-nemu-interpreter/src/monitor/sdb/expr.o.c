...
# 6 "/home/zz/github/ics2021/nemu/include/memory/vaddr.h"
...
# 82 "src/monitor/sdb/expr.c"
  ...
  if (ret != 0)
  {
   ...
   do { if (!(0)) { (fflush(
# 86 "src/monitor/sdb/expr.c" 3 4
  stdout
# 86 "src/monitor/sdb/expr.c"
  ), fprintf(
# 86 "src/monitor/sdb/expr.c" 3 4
  stderr
# 86 "src/monitor/sdb/expr.c"
  , "\33[1;31m" "regex compilation failed: %s\n%s" "\33[0m" "\n", error_msg, rules[i].regex)); extern void assert_fail_msg(); assert_fail_msg(); 
# 86 "src/monitor/sdb/expr.c" 3 4
  (static_cast <bool> (
# 86 "src/monitor/sdb/expr.c"
  0
...
# 86 "src/monitor/sdb/expr.c"
  "0"
# 86 "src/monitor/sdb/expr.c" 3 4
  , "src/monitor/sdb/expr.c", 86, __extension__ __PRETTY_FUNCTION__))
# 86 "src/monitor/sdb/expr.c"
  ; } } while (0);
  }
 }
...
# 146 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 146 "src/monitor/sdb/expr.c"
...
"isalpha(ch) || isdigit(ch)"
# 146 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 146, __extension__ __PRETTY_FUNCTION__))
# 146 "src/monitor/sdb/expr.c"
                                  ;
...
"0"
# 159 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 159, __extension__ __PRETTY_FUNCTION__))
# 159 "src/monitor/sdb/expr.c"
         ;
}
...
# 164 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 164 "src/monitor/sdb/expr.c"
str && (base == 2 || base == 10 || base == 16)
# 164 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 164 "src/monitor/sdb/expr.c"
"str && (base == 2 || base == 10 || base == 16)"
# 164 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 164, __extension__ __PRETTY_FUNCTION__))
# 164 "src/monitor/sdb/expr.c"
                                                      ;
...
static bool make_token(char *e)
{
 ...
 while (e[position] != '\0')
 {
  ...
  for (; i < (int)(sizeof(rules) / sizeof(rules[0])); ++i)
  {
   if (numOfTokens == ((32)))
   {
   ...
   if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 && pmatch.rm_so == 0)
   {
    ...
    if (substr_len > (((32)) - 1))
    {
     printf("\33[1;31m" "Since buffer size is only %d. The length for string %d is too long.\n" "\33[0m", (((32)) - 1), substr_len)
  ...
  {
   printf("\33[1;31m" "no match at position %d\n%s\n%*.s^\n" "\33[0m", position, e, position, "");
   return false;
  }
 }
...
static int getOpPrecedence(const TokenType tk)
{
 ...
 default:
  do { if (!(0)) { (fflush(
# 294 "src/monitor/sdb/expr.c" 3 4
 stdout
# 294 "src/monitor/sdb/expr.c"
 ), fprintf(
# 294 "src/monitor/sdb/expr.c" 3 4
 stderr
# 294 "src/monitor/sdb/expr.c"
 , "\33[1;31m" "Op %d" "\33[0m" "\n", tk)); extern void assert_fail_msg(); assert_fail_msg(); 
# 294 "src/monitor/sdb/expr.c" 3 4
 (static_cast <bool> (
# 294 "src/monitor/sdb/expr.c"
 0
...
# 294 "src/monitor/sdb/expr.c"
 "0"
# 294 "src/monitor/sdb/expr.c" 3 4
 , "src/monitor/sdb/expr.c", 294, __extension__ __PRETTY_FUNCTION__))
# 294 "src/monitor/sdb/expr.c"
 ; } } while (0);
 }
}
 ...
 case TK_DIV:
  {
   if (right == 0)
   {
    printf("\33[1;31m" "%s" "\33[0m", "Divide by 0\n");
    goto error;
   }
 ...
 case TK_MOD:
  {
   if (right == 0)
   {
    printf("\33[1;31m" "%s" "\33[0m", "Mod by 0\n");
    goto error;
   }
...
# 351 "src/monitor/sdb/expr.c" 3 4
 (static_cast <bool> (
# 351 "src/monitor/sdb/expr.c"
 0
# 351 "src/monitor/sdb/expr.c" 3 4
 ) ? void (0) : __assert_fail (
# 351 "src/monitor/sdb/expr.c"
 "0"
# 351 "src/monitor/sdb/expr.c" 3 4
 , "src/monitor/sdb/expr.c", 351, __extension__ __PRETTY_FUNCTION__))
# 351 "src/monitor/sdb/expr.c"
          ;
 }
...
# 367 "src/monitor/sdb/expr.c"
          "0"
# 367 "src/monitor/sdb/expr.c" 3 4
          , "src/monitor/sdb/expr.c", 367, __extension__ __PRETTY_FUNCTION__))
# 367 "src/monitor/sdb/expr.c"
                   ;
 }
}
...
static int getMainBiOp(int start, int end, bool* success)
{
 ...
 for (; end >= start; --end)
 {
  ...
  if (isBiOperator(curType))
  {
   ...
   minOpPrecedence = ((minOpPrecedence > curOpPrecedence) ? minOpPrecedence : curOpPrecedence);
  }
 }
...
# 440 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 440 "src/monitor/sdb/expr.c"
start <= end
# 440 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 440 "src/monitor/sdb/expr.c"
"start <= end"
# 440 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 440, __extension__ __PRETTY_FUNCTION__))
# 440 "src/monitor/sdb/expr.c"
                    ;
...
# 466 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 466 "src/monitor/sdb/expr.c"
start <= end
# 466 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 466 "src/monitor/sdb/expr.c"
"start <= end"
# 466 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 466, __extension__ __PRETTY_FUNCTION__))
# 466 "src/monitor/sdb/expr.c"
                    ;
...
# 496 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 496 "src/monitor/sdb/expr.c"
start <= end
# 496 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 496 "src/monitor/sdb/expr.c"
"start <= end"
# 496 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 496, __extension__ __PRETTY_FUNCTION__))
# 496 "src/monitor/sdb/expr.c"
                    ;
...
static word_t eval(int start, int end, bool* success)
{
 if (end < start)
 {
  printf("\33[1;31m" "Cannot invoke this expression.\n" "Start token %s\n" "End token   %s\n" "\33[0m", tokens[start].str, tokens[end].str)
...
# 579 "src/monitor/sdb/expr.c" 3 4
  (static_cast <bool> (
# 579 "src/monitor/sdb/expr.c"
  0
# 579 "src/monitor/sdb/expr.c" 3 4
  ) ? void (0) : __assert_fail (
# 579 "src/monitor/sdb/expr.c"
  "0"
# 579 "src/monitor/sdb/expr.c" 3 4
  , "src/monitor/sdb/expr.c", 579, __extension__ __PRETTY_FUNCTION__))
# 579 "src/monitor/sdb/expr.c"
           ;
  }
 }
...
# 622 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 622 "src/monitor/sdb/expr.c"
mainOpIndex != -1
# 622 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 622 "src/monitor/sdb/expr.c"
"mainOpIndex != -1"
# 622 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 622, __extension__ __PRETTY_FUNCTION__))
# 622 "src/monitor/sdb/expr.c"
                         ;
...
# 718 "src/monitor/sdb/expr.c" 3 4
(static_cast <bool> (
# 718 "src/monitor/sdb/expr.c"
numOfTokens != 0
# 718 "src/monitor/sdb/expr.c" 3 4
) ? void (0) : __assert_fail (
# 718 "src/monitor/sdb/expr.c"
"numOfTokens != 0"
# 718 "src/monitor/sdb/expr.c" 3 4
, "src/monitor/sdb/expr.c", 718, __extension__ __PRETTY_FUNCTION__))
# 718 "src/monitor/sdb/expr.c"
                        ;
 ...
 if (numOfTokens == 1)
 {
  ...
  {
  case TK_REGS:
   return isa_reg_str2val((tokens[0].str + 1), success);
  case TK_HEX_NUM:
  ...
  default:
   printf("\33[1;31m" "%s" "\33[0m", "Unknown expression when only one token.\n");
   *success = false;
   return -1;
  }
 }
 ...
 *success = isAllParenthesesMatch(0, numOfTokens - 1);
 if (!*success)
 {
  printf("\33[1;31m" "%s" "\33[0m", "Bad expression: unmatch parentheses.\n");
  return -1;
 }
