# 0 "src/isa/riscv32/instr/decode.c"
...
# 0 "<command-line>" 2
# 1 "src/isa/riscv32/instr/decode.c"
# 1 "src/isa/riscv32/instr/../local-include/reg.h" 1
...
# 5 "src/isa/riscv32/instr/../local-include/reg.h" 2

static inline int check_reg_idx(int idx)
{
 
# 8 "src/isa/riscv32/instr/../local-include/reg.h" 3 4
(static_cast <bool> (
# 8 "src/isa/riscv32/instr/../local-include/reg.h"
idx >= 0 && idx < 32
# 8 "src/isa/riscv32/instr/../local-include/reg.h" 3 4
...
"idx >= 0 && idx < 32"
# 8 "src/isa/riscv32/instr/../local-include/reg.h" 3 4
, "src/isa/riscv32/instr/../local-include/reg.h", 8, __extension__ __PRETTY_FUNCTION__))
# 8 "src/isa/riscv32/instr/../local-include/reg.h"
                                                    ;
 return idx;
}
...
# 2 "src/isa/riscv32/instr/decode.c" 2
# 1 "/home/zz/github/ics2021/nemu/include/cpu/ifetch.h" 1
...
# 4 "/home/zz/github/ics2021/nemu/include/cpu/ifetch.h" 2
...
# 3 "src/isa/riscv32/instr/decode.c" 2
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/isa-all-instr.h" 1
# 1 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 1
...
# 5 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 2
...
# 78 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
...
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stdout
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ), fprintf(
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stderr
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 , "\33[1;31m" "invalid character '%c' in pattern string" "\33[0m" "\n", c)); extern void assert_fail_msg(); assert_fail_msg(); 
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 (static_cast <bool> (
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 c == '0' || c == '1' || c == '?'
...
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 "c == '0' || c == '1' || c == '?'"
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 , "/home/zz/github/ics2021/nemu/include/cpu/decode.h", 84, __extension__ __PRETTY_FUNCTION__))
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
...
# 84 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ; } } while (0); __key = (__key << 1) | (c == '1' ? 1 : 0); __mask = (__mask << 1) | (c == '?' ? 0 : 1); __shift = (c == '?' ? __shift + 1 : 0); } };
  do { if (!(0)) { (fflush(
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stdout
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ), fprintf(
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stderr
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
...
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 "0"
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 , "/home/zz/github/ics2021/nemu/include/cpu/decode.h", 85, __extension__ __PRETTY_FUNCTION__))
# 85 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ; } } while (0);
#undef macro
finish:
...
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
  if ((0) >= len) goto finish; else { char c = str[0]; if (c != ' ') { do { if (!((c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?')) { (fflush(
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stdout
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ), fprintf(
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
...
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 "(c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?'"
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 , "/home/zz/github/ics2021/nemu/include/cpu/decode.h", 111, __extension__ __PRETTY_FUNCTION__))
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
...
# 111 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ; } } while (0); __key = (__key << 4) | (c == '?' ? 0 : (c >= '0' && c <= '9') ? c - '0' : c - 'a' + 10); __mask = (__mask << 4) | (c == '?' ? 0 : 0xf); __shift = (c == '?' ? __shift + 4 : 0); } };
  do { if (!(0)) { (fflush(
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stdout
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ), fprintf(
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 stderr
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
...
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 "0"
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h" 3 4
 , "/home/zz/github/ics2021/nemu/include/cpu/decode.h", 112, __extension__ __PRETTY_FUNCTION__))
# 112 "/home/zz/github/ics2021/nemu/include/cpu/decode.h"
 ; } } while (0);
#undef macro
finish:
...
#define def_INSTR_raw(decode_fun,pattern,body) do { uint32_t key, mask, shift; decode_fun(pattern, STRLEN(pattern), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { body; } } while (0)





#define def_INSTR_IDTABW(pattern,id,tab,width) def_INSTR_raw(pattern_decode, pattern, { concat(decode_, id)(s, width); return concat(table_, tab)(s); })
...
#define def_hex_INSTR_IDTABW(pattern,id,tab,width) def_INSTR_raw(pattern_decode_hex, pattern, { concat(decode_, id)(s, width); return concat(table_, tab)(s); })
...
# 2 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/isa-all-instr.h" 2
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/rtl.h" 1

#define __RISCV32_RTL_H__ 

# 1 "/home/zz/github/ics2021/nemu/include/rtl/rtl.h" 1
...
# 1 "/home/zz/github/ics2021/nemu/src/engine/interpreter/rtl-basic.h" 1

#define __RTL_BASIC_H__ 

# 1 "/home/zz/github/ics2021/nemu/src/engine/interpreter/c_op.h" 1
...
# 26 "/home/zz/github/ics2021/nemu/src/engine/interpreter/c_op.h"
...
# 45 "/home/zz/github/ics2021/nemu/src/engine/interpreter/rtl-basic.h"
...
# 5 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/rtl.h" 2
# 1 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/reg.h" 1
# 6 "/home/zz/github/ics2021/nemu/src/isa/riscv32/include/../local-include/rtl.h" 2
...
{
    decode_op_r(s, (&(s->src1)), s->isa.instr.r.rs1, false);
    decode_op_r(s, (&(s->src2)), s->isa.instr.r.rs2, false);
    decode_op_r(s, (&(s->dest)), s->isa.instr.r.rd, true);
}

static void decode_I (Decode *s, int width)
{
    decode_op_r(s, (&(s->src1)), s->isa.instr.i.rs1, false);
    decode_op_i(s, (&(s->src2)), s->isa.instr.i.simm11_0, false);
    decode_op_r(s, (&(s->dest)), s->isa.instr.i.rd, true);
}

static void decode_S (Decode *s, int width)
{
    decode_op_r(s, (&(s->src1)), s->isa.instr.s.rs1, false);
    sword_t simm = (s->isa.instr.s.simm11_5 << 5) | s->isa.instr.s.imm4_0;
    decode_op_i(s, (&(s->src2)), simm, false);
    decode_op_r(s, (&(s->dest)), s->isa.instr.s.rs2, false);
}

static void decode_B (Decode *s, int width)
{

    decode_op_r(s, (&(s->src1)), s->isa.instr.b.rs1, false);


    decode_op_r(s, (&(s->src2)), s->isa.instr.b.rs2, false);
    ...
    rtl_li(s, (tmp_reg), simm);
}

static void decode_U (Decode *s, int width)
{

    decode_op_i(s, (&(s->src1)), s->isa.instr.u.imm31_12 << 12, true);

    decode_op_r(s, (&(s->dest)), s->isa.instr.u.rd, true);
}
...
static void decode_J (Decode *s, int width)
{
    ...
    decode_op_i(s, (&(s->src1)), cur_imm, false);
    decode_op_r(s, (&(s->dest)), s->isa.instr.j.rd, true);
}
# 108 "src/isa/riscv32/instr/decode.c"
...
static inline int table_OP_IMM (Decode *s)
{
    ...
    do { uint32_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? ????? ??", (sizeof("??????? ????? ????? 000 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_addi(s); }; } } while (0);
...
static inline int table_JALR (Decode *s)
{

    do { uint32_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? ????? ??", (sizeof("??????? ????? ????? 000 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_jalr(s); }; } } while (0);
...
static inline int table_OP (Decode *s)
{
    ...
    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 000 ????? ????? ??", (sizeof("0000001 ????? ????? 000 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_mul(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 001 ????? ????? ??", (sizeof("0000001 ????? ????? 001 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_mulh(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 010 ????? ????? ??", (sizeof("0000001 ????? ????? 010 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_mulhsu(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 011 ????? ????? ??", (sizeof("0000001 ????? ????? 011 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_mulhu(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 100 ????? ????? ??", (sizeof("0000001 ????? ????? 100 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_div(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 101 ????? ????? ??", (sizeof("0000001 ????? ????? 101 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_divu(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 110 ????? ????? ??", (sizeof("0000001 ????? ????? 110 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_rem(s); }; } } while (0);

    do { uint32_t key, mask, shift; pattern_decode("0000001 ????? ????? 111 ????? ????? ??", (sizeof("0000001 ????? ????? 111 ????? ????? ??") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_empty(s, 0); return table_remu(s); }; } } while (0);
...
# 279 "src/isa/riscv32/instr/decode.c"
    ...
    do { uint32_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 00101 11", (sizeof("??????? ????? ????? ??? ????? 00101 11") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_U(s, 0); return table_auipc(s); }; } } while (0);


    do { uint32_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 01100 11", (sizeof("??????? ????? ????? ??? ????? 01100 11") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_R(s, 0); return table_OP(s); }; } } while (0);
...
# 302 "src/isa/riscv32/instr/decode.c"
    ...
    do { uint32_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 11001 11", (sizeof("??????? ????? ????? ??? ????? 11001 11") - 1), &key, &mask, &shift); if (((get_instr(s) >> shift) & mask) == key) { { decode_I(s, 0); return table_JALR(s); }; } } while (0);
